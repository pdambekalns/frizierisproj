import laiks #Importē lietotāja definētu funkciju.
import cenas #Importē lietotāja definētu funkciju.
from datetime import datetime # Importē datumus un laikus no funkcijas "datetime".
dienas=[] # Izveido tukšu listu.
...
def funkcija(izvele): # izveido funkciju un piešķir tai vērtību.
    if izvele == "A": # Pārbauda vai "izvele" ir vienādā ar "A", ja ir, tad zemākās darbības izvadīs konsolē, to ko lietotājs ir izvēlējies.
      ...
      if skaits == 0: # Pārbauda vai līniju skaits ir 0, ja nulle, tad izvada teksu, kas redzams zemāk.
          print("Nav neviena pieraksta!!") 
          print() 
      else: # Parbauda vai līniju skaits nav nulle, ja nav, tad nolasa un izvada tekstu no faila nolasītās līnijas.
    ...
    elif izvele == "B": # Pārbauda vai "izvele" ir vienādā ar "B", ja ir, tad zemākās darbības izvadīs konsolē, attiecībā pret to ko lietotājs ir izvēlējies.
      with open("rezervacijas.txt", "r") as file: # fails tiek atvērts. Rindas zemāk pārbauda rezervacijas numuru, ja failā nolasītā rinda sakrīt ar simbolu "#", tad nakamajai rindai piešķir nākamo numuru.
      ...
      # Kad rindai piešķirts numurs, tad konsolē uzdod jautājumus un lietotājam jāievada vārdu, uzvārdu un datumu.
      vards = input("Ievadi vārdu un uzvārdu: ")
      print()
      datums = input("Ievadi datumu (ievadi-gadu.mēnesi.dienu-(Pimēram:2022.02.16)): ")
      print()
      dienas=datums.split(".") # datumu sadala un ieliek listā kā trīs dažādus mainīgos.
      #print(dienas)
      for i in range(0, len(dienas)): # Pārbauda vai datums ir derīgs. Ja nav tad izvada "Ievadi pareizu datumu!"
      ...
      if dienas[0]<2021:
        ...
        if d.weekday()>4:
          print("Šī ir brīvdiena, izvēlieties citu datumu.") # Ja brīvdiena tad izvada šo tekstu.
            ...
            print() # Izsauc importēto funkciju, piešķir mainīgajam lietotāja ievadīto vērtību.
            t_nr =input("Ievadi talruņa nr.: ") # Piešķir mainīgajam lietotāja ievadīto atbildi uz jautājumu.
            print() 
            cena= cenas.samaksa(frizieris) # Izsauc importēto funkciju, piešķir mainīgajam lietotāja ievadīto vērtību.
            print()
        ...
        file2 = open("rezervacijas.txt", "w") # Failu atver, lai pierakstītu informāciju.

        for line in linijas: # Izdzēš līniju, kuras numurs sakrīt ar lietotāja ievadīto.
    ...
    else: #Lietotāja ievadītā atbilde nesakrīt ar nevienu no konsolē piedāvātajām izvēlēm.
